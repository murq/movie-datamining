...
linear_params = {'C':numpy.logspace(-3,4,8), 'kernel':['linear']} #C=[0.001,0.01,0.1,1,10,100,1000,10000]
...
poly_params = {'C':numpy.logspace(-3,4,8), 'kernel':['poly'],'degree':range(2,4)} #C=[0.001,0.01,0.1,1,10,100,1000,10000], degree=[2,3]
